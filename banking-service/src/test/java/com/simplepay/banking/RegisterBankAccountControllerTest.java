package com.simplepay.banking;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.simpleply.banking.adapter.in.web.RegisterBankAccountRequest;
...
public class RegisterBankAccountControllerTest {
    ...
    public void testBankAccount() throws Exception {
        RegisterBankAccountRequest request = new RegisterBankAccountRequest("1", "국민은행", "12345", true);
        mockMvc.perform(
